...
Ui_GeneratorWindow, QGeneratorWindow = loadUiType('List_generators.ui')  # GUI vom Hauptfenster

print("Let's go")


class List_generators(Ui_GeneratorWindow, QGeneratorWindow):

    def __init__(self):

        super(List_generators, self).__init__()
        self.setupUi(self)
